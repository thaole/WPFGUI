...
namespace LINQToSQL
{
    ...
    partial void DeleteSupplier(Supplier instance);
		...
		public NorthWindDataClassesDataContext() : 
				base(global::L2S_Northwind.Properties.Settings.Default.NorthwindConnectionString1, mappingSource)
		{
			OnCreated();
		}
		...
		[Function(Name="dbo.GetProductsByCategory")]
		public ISingleResult<Product> GetProductsByCategory([Parameter(DbType="Int")] System.Nullable<int> categoryId)
		{
		...
		[Function(Name="dbo.GetProductNameByCategoryID")]
		public ISingleResult<GetProductNameByCategoryIDResult> GetProductNameByCategoryID([Parameter(DbType="Int")] System.Nullable<int> categoryID, [Parameter(DbType="Int")] ref System.Nullable<int> count)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), categoryID, count);
			count = ((System.Nullable<int>)(result.GetParameterValue(1)));
			return ((ISingleResult<GetProductNameByCategoryIDResult>)(result.ReturnValue));
		}
		
		[Function(Name="dbo.MyUpperFunction", IsComposable=true)]
		public string MyUpperFunction([Parameter(DbType="VarChar(100)")] string inputString)
		{
	...
	public partial class GetProductNameByCategoryIDResult
	{
		
		private string _ProductName;
		
		public GetProductNameByCategoryIDResult()
		{
		}
